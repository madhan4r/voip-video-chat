<template>
  <div class="col-md-6 box">
    <div class="roomTitle">
      ...
      <span v-else-if="!loading && roomName">
        Connected to {{ roomName }}
        <button @click="leaveRoomIfJoined">leave</button></span
      >
...
import { BASE_URL } from "@/service_urls.js";
  ...
  methods: {
    async getAccessToken() {
      return await axios.post(
        `${BASE_URL}/communication/token?identity=${this.username}`
      );
    },
    // Trigger log events
    dispatchLog(message) {
